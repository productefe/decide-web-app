...
const VISION_OUTFIT_PROMPT =
  'Analyze this fashion image. Identify distinct clothing items the person is wearing (max 4: top, bottom, shoes, outerwear). Skip small accessories unless prominent. Be precise about garment TYPE and FIT — e.g. crop top vs oversized t-shirt vs slim tee; skinny jeans vs wide-leg. Return ONLY valid JSON, no markdown:\n{"items":[{"label":"Tişört","category":"exact type like crop top/t-shirt/jeans/sneaker/hoodie/jacket","colors":["primary color"],"fit":"slim/regular/oversized/loose/cropped","collar":"crew neck/v-neck/polo/turtleneck/none","pattern":"plain/striped/floral/graphic/logo/checkered/none","has_logo":false,"style_tags":["casual"],"gender":"men/women/unisex"}]}\nThe "label" value must be ONLY the item name in Turkish (e.g. Crop Top, Tişört, Pantolon, Ayakkabı, Ceket) — no English words, no explanations.\nIf only one item is visible, return one item in the array.';
