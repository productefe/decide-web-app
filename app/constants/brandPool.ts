...
export const WOMEN_TREND_PRIORITY_BRANDS = [
  "Bershka",
  "Stradivarius",
  "Pull&Bear",
  "Zara",
...
export const BRAND_POOL: BrandPoolEntry[] = [
  ...
  { category: "tops", tier: "affordable", brands: ["Koton", "LC Waikiki"], iconicFor: ["basic tişört"] },
  {
    category: "tops",
    tier: "affordable",
    brands: ["Bershka", "Stradivarius", "Pull&Bear", "Zara", "Mango"],
    iconicFor: ["kadın üst", "kadın tişört", "bluz"],
  },
  {
    category: "tops",
    tier: "luxury",
  ...
  },
  {
    category: "crop",
    tier: "affordable",
    brands: ["Stradivarius", "H&M", "Bershka", "Addax", "Quzu"],
    iconicFor: ["askılı basic"],
  },
  {
    category: "crop",
    tier: "luxury",
  ...
  { category: "crop", tier: "luxury", brands: ["Pinko", "Elisabetta Franchi"], iconicFor: ["büstiyer"] },
  {
    ...
    tier: "luxury",
    designer: true,
    brands: ["Nocturne", "Zeynep Arçay", "Raisa Vanessa", "Mehtap Elaidi"],
  },
  ...
  { category: "bottoms", tier: "affordable", brands: ["Levi's", "Mavi", "Bershka", "Zara"], iconicFor: ["jean"] },
  ...
  { category: "dress", tier: "affordable", brands: ["İpekyol", "Machka", "Mango", "Zara"], iconicFor: ["günlük şık"] },
  {
    category: "dress",
    tier: "luxury",
